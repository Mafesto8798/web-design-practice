...
export const ChordProgression = ({progression,clearProgression} : ChordProgressionProps) => {
    ...
    return(
        ...
        <div className="text-slate-700 dark:text-slate-200 flex flex-col items-center gap- w-full justify-evenly p-2 my-6">
            ...
            <button className="mx-2 my-2 px-4 py-1 inset-shadow-sm/50 inset-shadow-slate-800 shadow-slate-600 shadow-md/100 bg-blue-500 text-slate-300 text-xl text-shadow-md/30 font-semibold text-shadow-slate-600 rounded-full" onClick={() => clearProgression()}>Clear</button>
            <button className="mx-2 my-2 px-4 py-1 inset-shadow-sm/50 inset-shadow-slate-800 shadow-slate-600 shadow-md/100 bg-green-500 text-slate-300 text-xl text-shadow-md/30 font-semibold text-shadow-slate-600 rounded-full">Save</button>
            </span>
