...
export const ChordProgression = ({progression,clearProgression,saveProgression} : ChordProgressionProps) => {
    ...
    return(
        ...
        <div className="text-slate-700 dark:text-slate-200 flex flex-col items-center gap- w-full justify-evenly p-2 my-6">
            ...
            <button className="mx-2 my-2 px-6 py-3  border-4 border-sky-700 bg-slate-800 text-slate-200 text-xl  font-semibold rounded-lg transition-all duration-100 hover:scale-110 active:scale-95 hover:cursor-pointer" onClick={() => clearProgression()}>Clear</button>
            <button className="mx-2 my-2 px-6 py-3  border-4 border-sky-700 bg-slate-800 text-slate-200 text-xl  font-semibold  rounded-lg transition-all duration-100 hover:scale-110 active:scale-95 hover:cursor-pointer" onClick={() => saveProgression(progression,"Test")}>Save</button>
            </span>
